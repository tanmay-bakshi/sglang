...
def _build_plans(
    ...
    """Build two fixed chunks covering FULL and final SWA pages exactly.
...
def _fixture(source_tp_size: int = 2, room_id: int = 101) -> _Fixture:
    ...
    swa_indices = swa_allocator.alloc(2)
