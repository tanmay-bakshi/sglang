...
class UnifiedRadixCacheSuite:
    ...
    def test_swa_eager_eviction_on_unfinished_req(self):
        ...
        req.kv.kv_allocated_len = pre_len
        req.last_node = cache.root_node_handle()
        req.cache_protected_len = 0
        req.swa_uuid_for_lock = None
        req.extra_key = None
    ...
    def _consume_staged_prefetch(
        ...
        return load_result.new_full_device_indices
    ...
    def test_buffer_only_read_path_roundtrip(self):
        ...
        load_result = cons.init_load_back(
            InitLoadBackParams(
                best_match_node=None, host_hit_length=held.num_tokens, req=req
            )
        )
        spliced = load_result.new_full_device_indices
    ...
    def test_buffer_load_back_swa_window_charged_at_admission(self):
        ...
        spliced = load_result.new_full_device_indices
        last_node = load_result.restored_node
    ...
    def test_scheduler_hicache_full_mamba_init_load_back_appends_new_indices(self):
        ...
        self.assertEqual(load_result.restored_node, leaf)
    ...
    def test_scheduler_hicache_load_back_fallback_keeps_old_anchor(self):
        ...
        self.assertEqual(load_result.restored_node, match.last_device_node)
    ...
    def test_load_back_abort_frees_unpublished_mamba_slot(self):
        ...
        load_result = cache.load_back(leaf, mem_quota=-(10**9), req=req)
    ...
    def test_load_back_load_failure_frees_unpublished_mamba_slot(self):
        ...
        with mock.patch.object(cache.cache_controller, "load", return_value=None):
            load_result = cache.load_back(leaf, req=req)
    ...
    def test_hicache_swa_load_back_uses_full_pool_capacity(self):
        ...
        with mock.patch.object(
            ...
            load_result = cache.load_back(leaf)
            self.assertIsNotNone(load_result)
