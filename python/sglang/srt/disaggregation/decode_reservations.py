...
class DecodeReservationAllocation:
    """One exact engine-issued child allocation.

    :ivar child_request_id: Ordered gateway child identity.
    :ivar decoder_slot_generation: Opaque allocation-generation UUID.
    :ivar bootstrap_room: Decoder-issued transfer room.
    :ivar request_slot: Exact request-pool slot.
    :ivar request_generation: Exact slot-reuse generation.
    :ivar writer_manifest_digest: SHA-256 writer membership digest.
    :ivar allocation_digest: SHA-256 physical allocation digest.
...
class DecodeReservationAuthority:
    ...
    def prepare(
        ...
        deadline_monotonic_ns = now_monotonic_ns + attempt.prepared_ttl_ms * 1_000_000
