...
def _queue_fixture(
    ...
    *,
    ...
    queue._next_reserved_bootstrap_room = 1 << 63
...
def test_pre_promotion_cancel_releases_every_resource_and_never_reuses_room(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """Cancellation frees owned resources while the room counter remains monotonic."""
