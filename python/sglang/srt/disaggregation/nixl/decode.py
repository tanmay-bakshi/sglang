...
class PackedNixlDecodeController:
    ...
    def __init__(
        ...
        :param manager: Owning TP1 NIXL decode manager.
        ...
        if manager.attn_tp_size != 1:
            raise ValueError("packed decode controller requires TP1 decode")
        if manager.attn_tp_rank != 0:
            raise ValueError("packed decode controller requires decode TP rank zero")
