...
class PackedDecodeRequestTransaction:
    ...
    def _canonical_auxiliary_writer(
        ...
        """Resolve the sole source TP0/PP0/CP0 auxiliary writer.
        ...
        writers = tuple(
            ...
            if writer.source_attn_tp_rank == 0
            and writer.source_pp_rank == 0
            and writer.source_cp_rank == 0
        )
        if len(writers) != 1:
            raise ValueError(
                "packed auxiliary plan requires exactly one source TP0/PP0/CP0 "
                "writer"
            )
        return writers[0]
