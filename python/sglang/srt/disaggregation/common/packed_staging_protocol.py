...
class PackedAuxiliaryPlan:
    ...
    :ivar canonical_writer_id: Sole TP0/PP0/CP0 source writer.
    ...
    def __post_init__(self) -> None:
        ...
        if (
            writer_id.source_attn_tp_rank != 0
            or writer_id.source_pp_rank != 0
            or writer_id.source_cp_rank != 0
        ):
            raise ValueError("auxiliary canonical writer must be source TP0/PP0/CP0")
